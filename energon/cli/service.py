...
@service.command()
@click.option("--model_name", default="hf_gpt2", type=str)
@click.option("--model_type", default="gpt", type=str)
...
def init(model_name,
    ...
    server.launch_engine(MODEL_CLASSES[model_name],
                        model_type,
                        max_batch_size,
                        tp_init_size,
                        pp_init_size,
