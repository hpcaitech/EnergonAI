...
#export PYTHONPATH=/home/lclzm/ColossalAI-Inference/example/HuggingFace_GPT2/

for ((i=1; i<${world_size}; i++))  
do
server_port=`expr $server_port_start + $i`
#uvicorn server:app --app-dir /home/lclzm/ColossalAI_Inference/energon/engine --port ${server_port} &
